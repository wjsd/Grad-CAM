...
- This repo uses the same examples as https://github.com/jacobgil/pytorch-grad-cam
  and thus there is some code adapted/copied from there in order to be able to verify my
  implementation (e.g. VGG sample preprocessing, standardizing the final outputs for visualization)
...
if __name__ == '__main__':
    ...
    for i in range(len(classes)):
        ...
        if g:
            ...
            # standardize grad values (similar to https://github.com/jacobgil/pytorch-grad-cam, for easier visualization)
